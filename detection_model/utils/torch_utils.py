...
class AveragedModel(torch.nn.Module):
    ...
    def __init__(self, model, device=None, avg_fn=None):
        ...
        self.module = deepcopy(model.module if is_parallel(model) else model).eval()  # FP32 EMA
    ...
    def update_attr(self, model, include=(), exclude=('process_group', 'reducer')):
        ...
        copy_attr(self.module.module if is_parallel(self.module) else self.module,
