...
from utils.vinbigdata import result2vinbigdata, pad_lesion_image_to_sample
...
def detect():
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                # save results format correspond to the mmdet format
                ...
                for *xyxy, conf, cls in det:  #
                    ...
                    if saved_im_num < opt.save_img_num or view_img:  # Add bbox to image
    ...
    out_csv_file = os.path.join(out, 'results_test_cls.csv')
    result2vinbigdata(results, out_csv_file, img_names, pre_scale=1.0)
