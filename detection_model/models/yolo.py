...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, Bottleneck, SPP, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP,
                 BottleneckCSP2, SPPCSP, VoVCSP, C3, SE, GC, SAM, SE_BottleneckCSP,
                 GCB_BottleneckCSP, SAM_BottleneckCSP]:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in [BottleneckCSP, BottleneckCSP2, SPPCSP, VoVCSP, C3, SE_BottleneckCSP, GCB_BottleneckCSP, SAM_BottleneckCSP]:
                args.insert(2, n)
                n = 1
